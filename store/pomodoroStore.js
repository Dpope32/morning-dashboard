class PomodoroStore {
    ...
    completeSession() {
        ...
        if (this.state.currentMode === 'work') {
            ...
            const needsLongBreak = this.state.completedSessions % this.state.settings.sessionsBeforeLongBreak === 0;
            this.state.currentMode = 'break';
            this.state.timeLeft = (needsLongBreak ? 
                this.state.settings.longBreakDuration : 
                this.state.settings.breakDuration) * 60;
        } else {
            this.state.currentMode = 'work';
            this.state.timeLeft = this.state.settings.workDuration * 60;
        }
...
window.pomodoroStore = new PomodoroStore();
